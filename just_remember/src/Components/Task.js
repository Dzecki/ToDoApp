  ...
  return (
    <div className='flex flex-col items-center w-[60%] h-[200px] my-4 text-gray-1000 border-2 border-gray-900 bg-gray-700'>
        ...
        <div className='flex justify-center items-end h-[30%] w-[100%] font-semibold'>
          ...
          {editMode ?
            <button className='w-[30%] h-[35px] border-2 border-gray-900 m-2 bg-blue-400' onClick={() => props.editTask(props.taskID, setEditMode)}>CONFIRM</button> :
            <button className='w-[30%] h-[35px] border-2 border-gray-900 m-2 bg-gray-700' onClick={() => setEditMode(true)}>EDIT</button>
          }
        </div>
    </div>
  )
